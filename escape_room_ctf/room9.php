...
if (isset($_SESSION['room9'])) {
    ...
    if((isset($_POST['sub'])))
    {
        ...
        if($passcode == $input)
        {
            $_SESSION['room9'] = $passcode;
            header("location:room10.php");
        }
        else
        {
...
<head>
    ...
    <title>Escape Room - Room 09</title>
...
<body style="background:#1a1a1a">
    ...
    <div class="text-center">
        <div class="row" style="position:relative;top:40px">
            <div class="col">
                <h1 style="color:#ca2f2f;">ROOM 9</h1>
            </div>
        </div>
        <div class="row" style="position:relative;top:50px">
            <div class="col">

                <p><a href="zip.zip" download>Click here !</a></p>
        ...
        <div class="row" style="position:relative;top:-37px">
            <div class="col">
            <form action="room9.php" method="POST" style="width:207px;margin-left:455px;text-align:center">
