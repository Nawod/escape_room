...
int main() 
{ 
    char encoded_string[] = "ZXNjYXBle0x1c2lmZXJ9"; 
    ...
    char *encode = base64Decoder(encoded_string, len_str); 
    
    if(strncmp(encode,input, 7)==0){
        printf("\nGreat! You got the chance to escape from this room\n(This key may help you in future too)\n");
    }
    else
    {
        while(1){
            printf("\nOh no! You are going to stuck in this room");
        }
    }
